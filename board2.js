...
import imageSrc from './BurtonFlightAttendantCamberSplitboard.webp'; // Import your image file
...
function MyComponent() {
  ...
  const fetchRobots = () => {
    fetch('http://localhost:8081/listRobots2B')
    ...
    return (
        ...
        */
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <h1 style={{ top: 5, fontSize: '2.5rem', fontFamily: 'serif', textAlign: 'center', position: "absolute" }}>Flight Attendant </h1>
            ...
            <div style={{ flex: 1 }}>
                <RobotGallery robots={robots} />
                <AddRobotForm onAddRobot={handleAddRobot} page="board2" />
                <DeleteRobotForm onDeleteRobot={handleDeleteRobot} page="board2" />
                <UpdateRobotForm onUpdateRobot={handleUpdateRobot} page="board2" />
                <FetchRobotForm page="board2" />
            </div>
