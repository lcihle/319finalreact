...
import imageSrc from './Gnu-GWO-Snowboard.jpg'; // Import your image file
...
function MyComponent() {
  ...
  const fetchRobots = () => {
    fetch('http://localhost:8081/listRobots4B')
    ...
    return (
        ...
        */
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <h1 style={{ top: 5, fontSize: '2.5rem', fontFamily: 'serif', textAlign: 'center', position: "absolute" }}>GWO </h1>
            ...
            <div style={{ flex: 1 }}>
                <RobotGallery robots={robots} />
                <AddRobotForm onAddRobot={handleAddRobot} page="board4" />
                <DeleteRobotForm onDeleteRobot={handleDeleteRobot} page="board4" />
                <UpdateRobotForm onUpdateRobot={handleUpdateRobot} page="board4" />
                <FetchRobotForm page="board4" />
            </div>
