...
import imageSrc from './ski1.jpeg'; // Import your image file
    ...
    return (
        ...
        */
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <h1 style={{ top: 5, fontSize: '2.5rem', fontFamily: 'serif', textAlign: 'center', position: "absolute" }}>Shadow Board</h1>
            ...
            <div style={{ flex: 1 }}>
                <RobotGallery robots={robots} />
                <AddRobotForm onAddRobot={handleAddRobot} page="ski1" />
                <DeleteRobotForm onDeleteRobot={handleDeleteRobot} page="ski1" />
                <UpdateRobotForm onUpdateRobot={handleUpdateRobot} page="ski1" />
                <FetchRobotForm page="ski1" />
            </div>
