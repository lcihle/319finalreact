...
import imageSrc from './ski6.jpeg'; // Import your image file
...
function MyComponent() {
  ...
  const fetchRobots = () => {
    fetch('http://localhost:8081/listRobots6')
    ...
    return (
        ...
        */
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <h1 style={{ top: 5, fontSize: '2.5rem', fontFamily: 'serif', textAlign: 'center', position: "absolute" }}>Snoozy Sliders</h1>
            ...
            <div style={{ flex: 1 }}>
                <RobotGallery robots={robots} />
                <AddRobotForm onAddRobot={handleAddRobot} page="ski6" />
                <DeleteRobotForm onDeleteRobot={handleDeleteRobot} page="ski6" />
                <UpdateRobotForm onUpdateRobot={handleUpdateRobot} page="ski6" />
                <FetchRobotForm page="ski6" />
            </div>
