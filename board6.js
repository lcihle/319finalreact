...
import imageSrc from './GNUHyperSnowboard.jpg'; // Import your image file
...
function MyComponent() {
  ...
  const fetchRobots = () => {
    fetch('http://localhost:8081/listRobots6B')
    ...
    return (
        ...
        */
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <h1 style={{ top: 5, fontSize: '2.5rem', fontFamily: 'serif', textAlign: 'center', position: "absolute" }}>Hyper </h1>
            ...
            <div style={{ flex: 1 }}>
                <RobotGallery robots={robots} />
                <AddRobotForm onAddRobot={handleAddRobot} page="board6" />
                <DeleteRobotForm onDeleteRobot={handleDeleteRobot} page="board6" />
                <UpdateRobotForm onUpdateRobot={handleUpdateRobot} page="board6" />
                <FetchRobotForm page="board6" />
            </div>
