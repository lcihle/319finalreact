...
import imageSrc from './Burton2022FamilyTreeHometownHeroXCamberSplitboard.webp'; // Import your image file
...
function MyComponent() {
  ...
  const fetchRobots = () => {
    fetch('http://localhost:8081/listRobots1B')
    ...
    return (
        ...
        */
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <h1 style={{ top: 5, fontSize: '2.5rem', fontFamily: 'serif', textAlign: 'center', position: "absolute" }}>Hometown Hero </h1>
            ...
            <div style={{ flex: 1 }}>
                <RobotGallery robots={robots} />
                <AddRobotForm onAddRobot={handleAddRobot} page="board1" />
                <DeleteRobotForm onDeleteRobot={handleDeleteRobot} page="board1" />
                <UpdateRobotForm onUpdateRobot={handleUpdateRobot} page="board1" />
                <FetchRobotForm page="board1" />
            </div>
