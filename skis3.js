...
import imageSrc from './ski3.jpeg'; // Import your image file
...
function MyComponent() {
  ...
  const fetchRobots = () => {
    fetch('http://localhost:8081/listRobots3')
    ...
    return (
        ...
        */
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <h1 style={{ top: 5, fontSize: '2.5rem', fontFamily: 'serif', textAlign: 'center', position: "absolute" }}>Snow Wolf</h1>
            ...
            <div style={{ flex: 1 }}>
                <RobotGallery robots={robots} />
                <AddRobotForm onAddRobot={handleAddRobot} page="ski3" />
                <DeleteRobotForm onDeleteRobot={handleDeleteRobot} page="ski3" />
                <UpdateRobotForm onUpdateRobot={handleUpdateRobot} page="ski3" />
                <FetchRobotForm page="ski3" />
            </div>
