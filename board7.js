...
import imageSrc from './Whitespace155Montano.webp'; // Import your image file
...
function MyComponent() {
  ...
  const fetchRobots = () => {
    fetch('http://localhost:8081/listRobots7B')
    ...
    return (
        ...
        */
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <h1 style={{ top: 5, fontSize: '2.5rem', fontFamily: 'serif', textAlign: 'center', position: "absolute" }}>Montana </h1>
            ...
            <div style={{ flex: 1 }}>
                <RobotGallery robots={robots} />
                <AddRobotForm onAddRobot={handleAddRobot} page="board7" />
                <DeleteRobotForm onDeleteRobot={handleDeleteRobot} page="board7" />
                <UpdateRobotForm onUpdateRobot={handleUpdateRobot} page="board7" />
                <FetchRobotForm page="board7" />
            </div>
