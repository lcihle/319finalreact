...
import imageSrc from './ski2.jpeg'; // Import your image file
...
function MyComponent() {
  ...
  const fetchRobots = () => {
    fetch('http://localhost:8081/listRobots2')
    ...
    return (
        ...
        */
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <h1 style={{ top: 5, fontSize: '2.5rem', fontFamily: 'serif', textAlign: 'center', position: "absolute" }}>Blue Beauty</h1>
