...
import imageSrc from './skigrey.jpg'; // Import your image file
...
function MyComponent() {
  ...
  const fetchRobots = () => {
    fetch('http://localhost:8081/listRobots8')
    ...
    return (
        ...
        */
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <h1 style={{ top: 5, fontSize: '2.5rem', fontFamily: 'serif', textAlign: 'center', position: "absolute" }}>Tactical Rider</h1>
            ...
            <div style={{ flex: 1 }}>
                <RobotGallery robots={robots} />
                <AddRobotForm onAddRobot={handleAddRobot} page="ski8" />
                <DeleteRobotForm onDeleteRobot={handleDeleteRobot} page="ski8" />
                <UpdateRobotForm onUpdateRobot={handleUpdateRobot} page="ski8" />
                <FetchRobotForm page="ski8" />
            </div>
