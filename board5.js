...
import imageSrc from './GNUFrostingSnowboard.jpg'; // Import your image file
...
function MyComponent() {
  ...
  const fetchRobots = () => {
    fetch('http://localhost:8081/listRobots5B')
    ...
    return (
        ...
        */
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <h1 style={{ top: 5, fontSize: '2.5rem', fontFamily: 'serif', textAlign: 'center', position: "absolute" }}>Frosting </h1>
            ...
            <div style={{ flex: 1 }}>
                <RobotGallery robots={robots} />
                <AddRobotForm onAddRobot={handleAddRobot} page="board5" />
                <DeleteRobotForm onDeleteRobot={handleDeleteRobot} page="board5" />
                <UpdateRobotForm onUpdateRobot={handleUpdateRobot} page="board5" />
                <FetchRobotForm page="board5" />
            </div>
