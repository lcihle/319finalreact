...
import imageSrc from './ski7.jpeg'; // Import your image file
...
function MyComponent() {
  ...
  const fetchRobots = () => {
    fetch('http://localhost:8081/listRobots7')
    ...
    return (
        ...
        */
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <h1 style={{ top: 5, fontSize: '2.5rem', fontFamily: 'serif', textAlign: 'center', position: "absolute" }}>Wavy Rider</h1>
            ...
            <div style={{ flex: 1 }}>
                <RobotGallery robots={robots} />
                <AddRobotForm onAddRobot={handleAddRobot} page="ski7" />
                <DeleteRobotForm onDeleteRobot={handleDeleteRobot} page="ski7" />
                <UpdateRobotForm onUpdateRobot={handleUpdateRobot} page="ski7" />
                <FetchRobotForm page="ski7" />
            </div>
