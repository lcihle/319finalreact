...
import imageSrc from './WhitespaceFreestyleShaunWhitePro.webp'; // Import your image file
...
function MyComponent() {
  ...
  const fetchRobots = () => {
    fetch('http://localhost:8081/listRobots8B')
    ...
    return (
        ...
        */
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <h1 style={{ top: 5, fontSize: '2.5rem', fontFamily: 'serif', textAlign: 'center', position: "absolute" }}>Shaun White Pro </h1>
            ...
            <div style={{ flex: 1 }}>
                <RobotGallery robots={robots} />
                <AddRobotForm onAddRobot={handleAddRobot} page="board8" />
                <DeleteRobotForm onDeleteRobot={handleDeleteRobot} page="board8" />
                <UpdateRobotForm onUpdateRobot={handleUpdateRobot} page="board8" />
                <FetchRobotForm page="board8" />
            </div>
