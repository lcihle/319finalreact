...
import imageSrc from './BurtonProcessCamberSnowboard.webp'; // Import your image file
...
function MyComponent() {
  ...
  const fetchRobots = () => {
    fetch('http://localhost:8081/listRobots3B')
    ...
    return (
        ...
        */
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <h1 style={{ top: 5, fontSize: '2.5rem', fontFamily: 'serif', textAlign: 'center', position: "absolute" }}>Camber </h1>
            ...
            <div style={{ flex: 1 }}>
                <RobotGallery robots={robots} />
                <AddRobotForm onAddRobot={handleAddRobot} page="board3" />
                <DeleteRobotForm onDeleteRobot={handleDeleteRobot} page="board3" />
                <UpdateRobotForm onUpdateRobot={handleUpdateRobot} page="board3" />
                <FetchRobotForm page="board3" />
            </div>
